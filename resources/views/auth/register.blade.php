                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="first_name" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('First Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="last_name" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('Last Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="street" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('Street') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="city" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('City') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('Phone Number') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="postal_code" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('Postal code') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="house_number" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('House Number') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="house_number_addition" class="col-md-4 col-form-label text-md-right" style="color: white">{{ __('House Number Addition') }}</label>
